...
let reviews = [
    {
        ...
        text: "Благодаря советам Джека отлично провели время в Тоскане! Арендовали машину, объехали все деревушки. Вино и виды невероятные! Обязательно вернёмся ещё раз.",
        date: "2024-03-15"
    },
    {
        id: 2,
        ...
        rating: 5,
        country: "Япония, Киото",
        text: "Киото весной — это что-то невероятное. Цветущая сакура, храмы и удивительная атмосфера. Советы по транспорту очень помогли. Сэкономили много времени!",
        date: "2024-04-02"
    },
    {
        id: 3,
        ...
        rating: 4,
        country: "Исландия",
        text: "Поездка в Исландию была мечтой. Совет про непромокаемую одежду очень пригодился. Северное сияние видели на третью ночь! Фотографии получились шикарные.",
        date: "2024-02-18"
    },
    {
        id: 4,
        ...
        text: "Стамбул покорил с первого взгляда! Айя-София и Голубая мечеть — это великолепие. На базарах действительно нужно торговаться, спасибо за совет!",
        date: "2024-05-10"
    },
    {
        id: 5,
        ...
        text: "Потрясающий отдых! Море, солнце, вкусная еда. Джек, спасибо за рекомендации по островам. Пхи-Пхи — это райское место! Обязательно приедем ещё.",
        date: "2024-06-22"
    },
    {
        id: 6,
        ...
        rating: 4,
        country: "Германия, Кёльн",
        text: "Кёльнский собор впечатляет своими размерами. Поднялись на башню — 533 ступени, но вид того стоит! Пиво Kölsch в местной пивной — отдельное удовольствие.",
        date: "2024-07-05"
    },
    {
        id: 7,
        ...
        rating: 5,
        country: "Норвегия, Берген",
        text: "Фьорды Норвегии — это любовь с первого взгляда. Горы, вода, свежий воздух. Северное сияние удалось поймать в Тромсё. Спасибо за полезный блог!",
        date: "2024-08-18"
    },
    {
        id: 8,
        author: "Игорь Белов",
        rating: 5,
        country: "Перу, Мачу-Пикчу",
        text: "Мачу-Пикчу — место силы! Древний город в облаках. Совет про акклиматизацию в Куско очень помог, избежали горной болезни. Незабываемое приключение!",
        date: "2024-09-12"
    }
];
